    ...
    <div className="flex flex-col gap-16 w-full pb-20">
      ...
      <div id="aboutMe">
        <div className="flex flex-col gap-6 text-xl max-w-[1000px] leading-relaxed text-black">
          <p>
            I am a first-generation college student from Salinas, California, and a 3rd-year undergraduate at UC Berkeley double majoring in Computer Science and Data Science, with a minor in Education.
          </p>
          <p>
